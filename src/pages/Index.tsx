...
const Index = () => {
  ...
  return (
    <Layout>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto fade-in-up">
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6 tracking-tight">
              <span className="gradient-text">Corner</span>
              <span className="text-gray-900">Tab</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-600 mb-8 leading-relaxed font-light">
              Artifacts for what comes next.<br />
              <span className="text-blue-600 font-medium">Wear the rebuild.</span>
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold px-8"
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map(({ label, value, icon: Icon }) => (
              <div key={label} className="text-center group">
                <div className="inline-flex p-3 rounded-xl bg-blue-100 text-blue-600 mb-4 group-hover:scale-110 transition-transform duration-200">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map(({ icon: Icon, title, description }) => (
              <Card key={title} className="card-clean hover-lift border-0 shadow-sm">
                <CardHeader className="text-center pb-4">
                  <div className="inline-flex p-4 rounded-xl bg-gradient-to-br from-blue-100 to-green-100 text-blue-600 mx-auto mb-4">
      ...
      {/* The Corner Teaser */}
      <section className="py-20 bg-gradient-to-r from-red-50 to-orange-50 border-y border-red-100">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Enter <span className="text-red-600">The Corner</span>
            </h2>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              ...
              <br />
              <span className="text-blue-600 font-medium">The future needs more builders, not critics.</span>
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                asChild
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="border-gray-300 text-gray-700 hover:bg-white/80 font-semibold px-8"
              >
